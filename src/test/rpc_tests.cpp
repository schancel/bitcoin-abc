...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values) {
    ...
    BOOST_CHECK_EQUAL(
        ValueFromAmount(123456789 * (COIN / 10000)).write(),
        "12345.67890000");
    BOOST_CHECK_EQUAL(ValueFromAmount(-1 * COIN).write(),
                      "-1.00000000");
    BOOST_CHECK_EQUAL(ValueFromAmount(-1 * COIN / 10).write(),
                      "-0.10000000");
    ...
    BOOST_CHECK_EQUAL(ValueFromAmount(100000 * COIN).write(),
                      "100000.00000000");
    BOOST_CHECK_EQUAL(ValueFromAmount(10000 * COIN).write(),
                      "10000.00000000");
    BOOST_CHECK_EQUAL(ValueFromAmount(1000 * COIN).write(),
                      "1000.00000000");
    BOOST_CHECK_EQUAL(ValueFromAmount(100 * COIN).write(),
                      "100.00000000");
    BOOST_CHECK_EQUAL(ValueFromAmount(10 * COIN).write(),
                      "10.00000000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN).write(),
                      "1.00000000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN / 10).write(),
                      "0.10000000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN / 100).write(),
                      "0.01000000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN / 1000).write(),
                      "0.00100000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN / 10000).write(),
                      "0.00010000");
    BOOST_CHECK_EQUAL(ValueFromAmount(COIN / 100000).write(),
                      "0.00001000");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values) {
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.00000000")), Amount(0LL));
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.00000001")), Amount(1LL));
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.17622195")),
                      Amount(17622195LL));
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("0.5")), Amount(50000000LL));
