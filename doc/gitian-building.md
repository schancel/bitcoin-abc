...
focus on creating a vagrant box.  However, you may run the provided provision
script on your favorite clean VM image using any virtualization option, or a
baremetal linux machine.  If you wish to setup machine using another
technology, please see the provided provisioning script for gitian in
`contrib/gitian/provisioner.sh`

To begin you will need to install the following tools:
...
project](https://github.com/boxcutter/ubuntu).  Follow their steps to generate
a box file for ubuntu1604.  It should be as simple as running the following
command: `packer build -var-file=ubuntu1604.json ubuntu.json`
...
this is Ubuntu Trusty x86_64. This image will be copied and used every time
